import{_ as a,c as e,o as n,ag as p}from"./chunks/framework.UtM2fnOC.js";const d=JSON.parse('{"title":"Compas examples","description":"","frontmatter":{},"headers":[],"relativePath":"examples.md","filePath":"examples.md"}'),t={name:"examples.md"};function l(i,s,o,r,c,m){return n(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="compas-examples" tabindex="-1">Compas examples <a class="header-anchor" href="#compas-examples" aria-label="Permalink to &quot;Compas examples&quot;">​</a></h1><p>Examples of how to do various tasks with Compas. These examples can be used via with <code>create-compas</code> to quickly start a new project.</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Via NPM</span></span>
