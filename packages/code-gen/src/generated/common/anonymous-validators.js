...
export function anonymousValidator368068670(
  ...
  result["hasDefaultValue"] = anonymousValidator1174857441(
...
export function anonymousValidator1519740867(
  ...
  result["sql"] = anonymousValidator368068670(
    value["sql"],
    `${propertyPath}.sql`,
    errors,
  );
...
export function anonymousValidator1899936374(
  ...
  result["schema"] = anonymousValidator1180542458(
    value["schema"],
    `${propertyPath}.schema`,
    errors,
  );
...
export function anonymousValidator1218262237(
  ...
  result["hasSqlDefault"] = anonymousValidator1174857441(
    value["hasSqlDefault"],
...
export function anonymousValidator1906374053(
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator1218262237(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
...
export function anonymousValidator1837423837(
  ...
  result["fields"] = anonymousValidator1906374053(
    value["fields"],
    `${propertyPath}.fields`,
    errors,
  );
...
export function anonymousValidator17105276(
  ...
  result["queryOptions"] = anonymousValidator1899936374(
    value["queryOptions"],
  ...
  result["partial"] = anonymousValidator1837423837(
    value["partial"],
...
export function anonymousValidator40811832(
  ...
  if (value["key"] !== "sqlReservedRelationKey") {
    const parentType = "string";
...
export function anonymousValidator373158856(
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator1835746810(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
...
export function anonymousValidator980814292(
  ...
  result["errors"] = anonymousValidator373158856(
    value["errors"],
    `${propertyPath}.errors`,
    errors,
  );
