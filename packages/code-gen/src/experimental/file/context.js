 ...
 *
 * @property {"doubleSlash"} inlineCommentStyle Supported inline comment styles. Defaults
...
export function fileContextFinalizeGenerateFile(generateFile) {
  if (
    generateFile.addGeneratedByComment &&
    generateFile.inlineCommentStyle === "doubleSlash"
  ) {
    // TODO: use comment helper for example for `.sql` files.
    return `// Generated by @compas/code-gen\n\n${generateFile.contents}\n`;
  }

  return `${generateFile.contents}\n`;
}
