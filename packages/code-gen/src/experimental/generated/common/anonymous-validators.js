...
const objectKeys2074712839 = new Set([
  "structure",
  "openApi",
  "router",
  "database",
...
const objectKeys126976955 = new Set(["target", "skipValidatorGeneration"]);
const objectKeys1620931104 = new Set(["dialect"]);
const objectKeys328211283 = new Set(["includeBaseTypes"]);
const objectKeys1817660202 = new Set([
  "target",
...
const objectKeys876151968 = new Set([
  "includeBaseTypes",
  "declareGlobalTypes",
 ...
 */
export function anonymousValidator957944460(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  return anonymousValidator775977628(value, propertyPath);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator1932964806(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  for (const key of Object.keys(value)) {
    ...
    const genericValue = anonymousValidator775977628(
      value[key],
...
export function anonymousValidator304308939(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1932964806(
      value["keys"],
      `${propertyPath}.keys`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator775977628(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<(import("./types").ExperimentalTypeSystemDefinition)[]>}
 */
export function anonymousValidator861629395(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator775977628(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
...
export function anonymousValidator1003855982(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator861629395(
      value["values"],
      `${propertyPath}.values`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator126976955(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "object") {
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys126976955.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys126976955],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator897743470(
      value["skipValidatorGeneration"],
      `${propertyPath}.skipValidatorGeneration`,
    );
    if (validatorResult.errors) {
      errors.push(...validatorResult.errors);
    } else {
      result["skipValidatorGeneration"] = validatorResult.value;
    }
  }
  if (errors.length > 0) {
    return { errors };
 ...
 */
export function anonymousValidator1817660202(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "object") {
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1817660202.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1817660202],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator897743470(
      value["skipResponseValidation"],
      `${propertyPath}.skipResponseValidation`,
    );
    if (validatorResult.errors) {
      errors.push(...validatorResult.errors);
    } else {
      result["skipResponseValidation"] = validatorResult.value;
    }
  }
  {
    const validatorResult = anonymousValidator897743470(
 ...
 */
export function anonymousValidator876151968(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "object") {
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys876151968.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys876151968],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator897743470(
      value["declareGlobalTypes"],
      `${propertyPath}.declareGlobalTypes`,
    );
    if (validatorResult.errors) {
      errors.push(...validatorResult.errors);
    } else {
      result["declareGlobalTypes"] = validatorResult.value;
    }
  }
  {
    const validatorResult = anonymousValidator897743470(
      value["declareGlobalCompasTypes"],
      `${propertyPath}.declareGlobalCompasTypes`,
    );
    if (validatorResult.errors) {
      errors.push(...validatorResult.errors);
    } else {
      result["declareGlobalCompasTypes"] = validatorResult.value;
    }
  }
  if (errors.length > 0) {
    return { errors };
 ...
 */
export function anonymousValidator2074712839(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys2074712839.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys2074712839],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator126976955(
      value["database"],
  ...
  {
    const validatorResult = anonymousValidator1817660202(
      value["apiClient"],
  ...
  {
    const validatorResult = anonymousValidator876151968(
      value["types"],
      `${propertyPath}.types`,
    );
    if (validatorResult.errors) {
...
export function anonymousValidator1671053633(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator2074712839(
      value["generators"],
