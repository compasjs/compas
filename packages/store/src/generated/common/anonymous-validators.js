...
const objectKeys1853104309 = new Set(["where", "limit", "offset"]);
...
const objectKeys1829604010 = new Set(["where", "limit", "offset"]);
...
const objectKeys104524856 = new Set(["$append"]);
const objectKeys968179752 = new Set(["$add"]);
const objectKeys1875589843 = new Set(["$subtract"]);
const objectKeys1191621661 = new Set(["$multiply"]);
const objectKeys1130945768 = new Set(["$divide"]);
const objectKeys1676957128 = new Set(["$set"]);
const objectKeys631355934 = new Set(["path", "value"]);
const objectKeys1756903266 = new Set(["$remove"]);
const objectKeys1518298062 = new Set(["path"]);
const objectKeys1448727623 = new Set(["$add"]);
const objectKeys1938829582 = new Set(["$subtract"]);
...
const objectKeys1372984526 = new Set(["$negate"]);
...
export function anonymousValidator599447075(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1415318131(
      value["contentLength"],
 ...
 * @returns {EitherN<number>}
 */
export function anonymousValidator959192986(value, propertyPath) {
  if (isNil(value)) {
    return { value: 75 };
  }
 ...
 * @returns {EitherN<number>}
 */
export function anonymousValidator779059505(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
...
export function anonymousValidator376443596(value, propertyPath) {
  ...
  let errors = [];
  {
    const validatorResult = anonymousValidator959192986(
      value["q"],
      `${propertyPath}.q`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator779059505(
      value["w"],
      `${propertyPath}.w`,
    );
    if (validatorResult.errors) {
 ...
 * @returns {EitherN<number>}
 */
export function anonymousValidator1430378002(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<number>}
 */
export function anonymousValidator1085866873(value, propertyPath) {
  if (isNil(value)) {
    return { value: 0 };
  }
  if (typeof value !== "number" || isNaN(value) || !isFinite(value)) {
 ...
 * @returns {EitherN<number>}
 */
export function anonymousValidator819610098(value, propertyPath) {
  if (isNil(value)) {
    return { value: 0 };
  }
  if (typeof value !== "number" || isNaN(value) || !isFinite(value)) {
 ...
 */
export function anonymousValidator1774217168(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "number" || isNaN(value) || !isFinite(value)) {
...
export function anonymousValidator1781782332(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1430378002(
      value["id"],
      `${propertyPath}.id`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1085866873(
      value["priority"],
  ...
  {
    const validatorResult = anonymousValidator819610098(
      value["retryCount"],
  ...
  {
    const validatorResult = anonymousValidator1774217168(
 ...
 */
export function anonymousValidator1262061822(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
 ...
 */
export function anonymousValidator168683807(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1262061822(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 * @returns {EitherN<undefined|(string)[]|QueryPart<any>>}
 */
export function anonymousValidator1754947038(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  /** @type {EitherN<undefined|(string)[]|QueryPart<any>>} */
  let result = { errors: [] };
  result = anonymousValidator1749769805(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator1282884050(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
...
export function anonymousValidator2074494218(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1262061822(
      value["$raw"],
      `${propertyPath}.$raw`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator168683807(
      value["idIn"],
      `${propertyPath}.idIn`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1754947038(
      value["bucketNameIn"],
  ...
  {
    const validatorResult = anonymousValidator1282884050(
      value["createdAtIn"],
 ...
 * @returns {EitherN<undefined|number>}
 */
export function anonymousValidator1807899599(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "number") {
 ...
 * @returns {EitherN<undefined|(number)[]>}
 */
export function anonymousValidator1206734089(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (!Array.isArray(value)) {
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator1430378002(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 */
export function anonymousValidator2132384135(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  let result = { errors: [] };
  result = anonymousValidator1206734089(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator1257773835(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1807899599(
      value["id"],
      `${propertyPath}.id`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator2132384135(
      value["idIn"],
      `${propertyPath}.idIn`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator1829604010(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "object") {
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1829604010.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1829604010],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
...
export function anonymousValidator1430489818(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1829604010(
      value["viaSession"],
  ...
  {
    const validatorResult = anonymousValidator1853104309(
 ...
 */
export function anonymousValidator1853104309(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  if (typeof value !== "object") {
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1853104309.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1853104309],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator104524856(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys104524856.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys104524856],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator807480730(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  let result = { errors: [] };
  result = anonymousValidator714133621(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator104524856(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator968179752(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys968179752.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys968179752],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator1875589843(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1875589843.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1875589843],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator1191621661(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1191621661.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1191621661],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator1130945768(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1130945768.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1130945768],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator286691701(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  let result = { errors: [] };
  result = anonymousValidator233585750(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator968179752(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator1875589843(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator1191621661(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator1130945768(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator554346959(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<(number|string)[]>}
 */
export function anonymousValidator1107403631(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator554346959(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 * @returns {EitherN<any>}
 */
export function anonymousValidator845873839(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 */
export function anonymousValidator631355934(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys631355934.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys631355934],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator1107403631(
      value["path"],
      `${propertyPath}.path`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator845873839(
      value["value"],
      `${propertyPath}.value`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator1676957128(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1676957128.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1676957128],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator631355934(
      value["$set"],
      `${propertyPath}.$set`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator1518298062(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1518298062.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1518298062],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator1756903266(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1756903266.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1756903266],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
  ...
  {
    const validatorResult = anonymousValidator1518298062(
      value["$remove"],
      `${propertyPath}.$remove`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator127590957(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1676957128(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator1756903266(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator1448727623(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1448727623.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1448727623],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator1938829582(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1938829582.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1938829582],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator271670071(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1448727623(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator1938829582(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator617486747(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator807480730(
      value["bucketName"],
      `${propertyPath}.bucketName`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator286691701(
      value["contentLength"],
      `${propertyPath}.contentLength`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator127590957(
      value["meta"],
      `${propertyPath}.meta`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator271670071(
      value["createdAt"],
      `${propertyPath}.createdAt`,
    );
    if (validatorResult.errors) {
 ...
 * @returns {EitherN<"*">}
 */
export function anonymousValidator2014568369(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 */
export function anonymousValidator1050795074(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("bucketName"|"contentLength"|"contentType"|"name"|"meta"|"id"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator931893632(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator1050795074(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 */
export function anonymousValidator1740425088(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  let result = { errors: [] };
  result = anonymousValidator2014568369(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator931893632(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator165104378(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1740425088(
      value["returning"],
 ...
 */
export function anonymousValidator1372984526(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (const key of Object.keys(value)) {
    if (!objectKeys1372984526.has(key)) {
      /** @type {{ errors: InternalError[] }} */
      return {
        errors: [
          {
            ...
            key: "validator.object.strict",
            info: {
              expectedKeys: [...objectKeys1372984526],
              foundKeys: [...Object.keys(value)],
            },
          },
        ],
 ...
 */
export function anonymousValidator333148209(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1372984526(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 * @returns {EitherN<undefined|number|{"$add": number, }|{"$subtract": number, }|{"$multiply": number, }|{"$divide": number, }>}
 */
export function anonymousValidator1828531684(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  /** @type {EitherN<undefined|number|{"$add": number, }|{"$subtract": number, }|{"$multiply": number, }|{"$divide": number, }>} */
  let result = { errors: [] };
  result = anonymousValidator1085866873(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator1172426459(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
 ...
 * @returns {EitherN<undefined|number|{"$add": number, }|{"$subtract": number, }|{"$multiply": number, }|{"$divide": number, }>}
 */
export function anonymousValidator1283670761(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  /** @type {EitherN<undefined|number|{"$add": number, }|{"$subtract": number, }|{"$multiply": number, }|{"$divide": number, }>} */
  let result = { errors: [] };
  result = anonymousValidator819610098(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator685912601(value, propertyPath) {
  if (isNil(value)) {
    return { value: value };
  }
  if (typeof value !== "number" || isNaN(value) || !isFinite(value)) {
 ...
 */
export function anonymousValidator1028136798(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  let result = { errors: [] };
  result = anonymousValidator685912601(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator600940900(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator333148209(
      value["isComplete"],
      `${propertyPath}.isComplete`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1828531684(
      value["priority"],
      `${propertyPath}.priority`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1172426459(
      value["data"],
      `${propertyPath}.data`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1283670761(
      value["retryCount"],
      `${propertyPath}.retryCount`,
    );
    if (validatorResult.errors) {
  ...
  {
    const validatorResult = anonymousValidator1028136798(
      value["handlerTimeout"],
      `${propertyPath}.handlerTimeout`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator2003196801(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("id"|"isComplete"|"priority"|"scheduledAt"|"name"|"data"|"retryCount"|"handlerTimeout"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1090807811(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator2003196801(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 */
export function anonymousValidator291938563(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1090807811(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator286367525(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator291938563(
      value["returning"],
      `${propertyPath}.returning`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator858055890(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
...
export function anonymousValidator2102646924(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator858055890(
      value["revokedAt"],
      `${propertyPath}.revokedAt`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator507364887(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("data"|"checksum"|"revokedAt"|"id"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1170198631(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator507364887(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 */
export function anonymousValidator1235425127(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator1170198631(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator1516794677(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1235425127(
      value["returning"],
      `${propertyPath}.returning`,
    );
    if (validatorResult.errors) {
...
export function anonymousValidator84897941(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator2137247797(
      value["expiresAt"],
      `${propertyPath}.expiresAt`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator710058415(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("expiresAt"|"revokedAt"|"createdAt"|"id"|"session"|"refreshToken")[]>}
 */
export function anonymousValidator2083462675(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator710058415(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
 ...
 */
export function anonymousValidator1448998675(value, propertyPath) {
  if (isNil(value)) {
    return { value: undefined };
  }
  /** @type {InternalError[]} */
  ...
  result = anonymousValidator2083462675(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
...
export function anonymousValidator1345595702(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1448998675(
      value["returning"],
      `${propertyPath}.returning`,
    );
    if (validatorResult.errors) {
 ...
 */
export function anonymousValidator1438891195(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 */
export function anonymousValidator139728562(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("id"|"bucketName"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator355618576(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator139728562(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
...
export function anonymousValidator1795948632(value, propertyPath) {
  ...
  let result = { errors: [] };
  result = anonymousValidator1438891195(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
  }
  result = anonymousValidator355618576(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator132943271(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("id"|"isComplete"|"name"|"scheduledAt"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1847506213(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator132943271(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
...
export function anonymousValidator685221527(value, propertyPath) {
  ...
  result = anonymousValidator1847506213(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator175371657(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("id"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1282838155(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator175371657(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
...
export function anonymousValidator1196685479(value, propertyPath) {
  ...
  result = anonymousValidator1282838155(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 */
export function anonymousValidator1416016878(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
 ...
 * @returns {EitherN<("id"|"session"|"expiresAt"|"refreshToken"|"revokedAt")[]>}
 */
export function anonymousValidator553328340(value, propertyPath) {
  if (isNil(value)) {
    /** @type {{ errors: InternalError[] }} */
    return {
      errors: [
  ...
  let errors = [];
  for (let i = 0; i < value.length; ++i) {
    const arrVar = anonymousValidator1416016878(
      value[i],
      propertyPath + "[" + i + "]",
    );
    if (arrVar.errors) {
...
export function anonymousValidator2086080888(value, propertyPath) {
  ...
  result = anonymousValidator553328340(value, propertyPath);
  if (result.errors) {
    errors.push(result.errors[0]);
  } else {
    return result;
 ...
 * @returns {EitherN<("bucketName"|"contentLength"|"contentType"|"name"|"meta"|"id"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1910125265(value, propertyPath) {
  if (isNil(value)) {
    return {
      value: [
        "bucketName",
...
export function anonymousValidator310044624(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1910125265(
      value["select"],
      `${propertyPath}.select`,
    );
    if (validatorResult.errors) {
 ...
 * @returns {EitherN<("id"|"isComplete"|"priority"|"scheduledAt"|"name"|"data"|"retryCount"|"handlerTimeout"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator1003897121(value, propertyPath) {
  if (isNil(value)) {
    return {
      value: [
        "id",
...
export function anonymousValidator343387919(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1003897121(
      value["select"],
      `${propertyPath}.select`,
    );
    if (validatorResult.errors) {
 ...
 * @returns {EitherN<("data"|"checksum"|"revokedAt"|"id"|"createdAt"|"updatedAt")[]>}
 */
export function anonymousValidator410704167(value, propertyPath) {
  if (isNil(value)) {
    return {
 ...
 * @returns {EitherN<("expiresAt"|"revokedAt"|"createdAt"|"id"|"session"|"refreshToken")[]>}
 */
export function anonymousValidator1559802755(value, propertyPath) {
  if (isNil(value)) {
    return {
      value: [
        "expiresAt",
...
export function anonymousValidator1856722848(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator1559802755(
      value["select"],
      `${propertyPath}.select`,
    );
    if (validatorResult.errors) {
...
export function anonymousValidator2093168415(value, propertyPath) {
  ...
  {
    const validatorResult = anonymousValidator410704167(
      value["select"],
      `${propertyPath}.select`,
    );
    if (validatorResult.errors) {
