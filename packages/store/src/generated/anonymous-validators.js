...
import { isQueryObject } from "@lbu/store";
...
const objectKeys208334559 = new Set([
  "$or",
  "id",
  "idNotEqual",
  "idIn",
...
const objectKeys416492486 = new Set([
  "$or",
  "id",
  "idNotEqual",
  "idIn",
...
const objectKeys1774761946 = new Set([
  "$or",
  "id",
  "idNotEqual",
  "idIn",
...
const objectKeys1295027217 = new Set([
  "$or",
  "id",
  "idNotEqual",
  "idIn",
...
const objectKeys609318220 = new Set([
  "$or",
  "id",
  "idNotEqual",
  "idIn",
...
const objectKeys1639293803 = new Set([
  "where",
  "as",
  "limit",
  "offset",
...
const objectKeys158500398 = new Set([
  "where",
  "as",
  "limit",
  "offset",
...
const objectKeys1325997287 = new Set([
  "where",
  "limit",
  "offset",
  "viaGroup",
...
const objectKeys1215466022 = new Set([
  "where",
  "limit",
  "offset",
  "viaFile",
...
const objectKeys533501019 = new Set([
  "where",
  "limit",
  "offset",
  "viaFile",
...
const objectKeys486606313 = new Set([
  "where",
  "as",
  "limit",
  "offset",
...
const objectKeys2046755126 = new Set(["where", "as", "limit", "offset"]);
const objectKeys1276637142 = new Set(["where", "limit", "offset"]);
const objectKeys35809239 = new Set(["where", "as", "limit", "offset"]);
const objectKeys1575195633 = new Set(["where", "limit", "offset"]);
/**
 * @param {*} value
 * @returns {boolean}
 */
 ...
 */
export function anonymousValidator996948639(
  value,
  propertyPath,
  errors = [],
  parentType = "array",
  ...
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator208334559(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
 ...
 */
export function anonymousValidator1723585866(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 * @returns {undefined|(string)[]|QueryPart|undefined}
 */
export function anonymousValidator1741865695(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 */
export function anonymousValidator476640319(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 */
export function anonymousValidator208334559(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys208334559.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["$or"] = anonymousValidator996948639(
    value["$or"],
    `${propertyPath}.$or`,
    errors,
  );
  ...
  result["idIn"] = anonymousValidator1723585866(
    value["idIn"],
    `${propertyPath}.idIn`,
    errors,
  );
  result["idNotIn"] = anonymousValidator1723585866(
    value["idNotIn"],
  ...
  result["bucketNameIn"] = anonymousValidator1741865695(
    value["bucketNameIn"],
    `${propertyPath}.bucketNameIn`,
    errors,
  );
  result["bucketNameNotIn"] = anonymousValidator1741865695(
  ...
  result["createdAtIn"] = anonymousValidator476640319(
    value["createdAtIn"],
    `${propertyPath}.createdAtIn`,
    errors,
  );
  result["createdAtNotIn"] = anonymousValidator476640319(
  ...
  result["updatedAtIn"] = anonymousValidator476640319(
    value["updatedAtIn"],
    `${propertyPath}.updatedAtIn`,
    errors,
  );
  result["updatedAtNotIn"] = anonymousValidator476640319(
  ...
  result["deletedAtIn"] = anonymousValidator476640319(
    value["deletedAtIn"],
    `${propertyPath}.deletedAtIn`,
    errors,
  );
  result["deletedAtNotIn"] = anonymousValidator476640319(
 ...
 */
export function anonymousValidator2069174062(
  value,
  propertyPath,
  errors = [],
  parentType = "array",
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator416492486(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
 ...
 * @returns {undefined|(string)[]|QueryPart|undefined}
 */
export function anonymousValidator1816820380(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 */
export function anonymousValidator416492486(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys416492486.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["$or"] = anonymousValidator2069174062(
    value["$or"],
    `${propertyPath}.$or`,
    errors,
  );
  ...
  result["fileIn"] = anonymousValidator1816820380(
    value["fileIn"],
    `${propertyPath}.fileIn`,
    errors,
  );
  result["fileNotIn"] = anonymousValidator1816820380(
    value["fileNotIn"],
  ...
  result["parentIn"] = anonymousValidator1816820380(
    value["parentIn"],
    `${propertyPath}.parentIn`,
    errors,
  );
  result["parentNotIn"] = anonymousValidator1816820380(
    value["parentNotIn"],
 ...
 */
export function anonymousValidator25341966(
  value,
  propertyPath,
  errors = [],
  parentType = "array",
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator1774761946(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
 ...
 */
export function anonymousValidator1774761946(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1774761946.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["$or"] = anonymousValidator25341966(
    value["$or"],
    `${propertyPath}.$or`,
    errors,
  );
 ...
 */
export function anonymousValidator989368297(
  value,
  propertyPath,
  errors = [],
  parentType = "array",
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator1295027217(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
 ...
 */
export function anonymousValidator20139509(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 * @returns {undefined|(Date)[]|QueryPart|undefined}
 */
export function anonymousValidator15187031(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 */
export function anonymousValidator1295027217(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1295027217.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["$or"] = anonymousValidator989368297(
    value["$or"],
    `${propertyPath}.$or`,
    errors,
  );
  ...
  result["idIn"] = anonymousValidator20139509(
    value["idIn"],
    `${propertyPath}.idIn`,
    errors,
  );
  result["idNotIn"] = anonymousValidator20139509(
    value["idNotIn"],
    `${propertyPath}.idNotIn`,
    errors,
  );
  ...
  result["nameIn"] = anonymousValidator1741865695(
    value["nameIn"],
    `${propertyPath}.nameIn`,
    errors,
  );
  result["nameNotIn"] = anonymousValidator1741865695(
    value["nameNotIn"],
  ...
  result["scheduledAtIn"] = anonymousValidator15187031(
    value["scheduledAtIn"],
    `${propertyPath}.scheduledAtIn`,
    errors,
  );
  result["scheduledAtNotIn"] = anonymousValidator15187031(
 ...
 */
export function anonymousValidator964861468(
  value,
  propertyPath,
  errors = [],
  parentType = "array",
  ...
  const result = Array.from({ length: value.length });
  for (let i = 0; i < value.length; ++i) {
    result[i] = anonymousValidator609318220(
      value[i],
      `${propertyPath}[${i}]`,
      errors,
    );
 ...
 * @returns {undefined|(Date)[]|QueryPart|undefined}
 */
export function anonymousValidator1463484601(
  value,
  propertyPath,
  errors = [],
  parentType = "anyOf",
 ...
 */
export function anonymousValidator609318220(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys609318220.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["$or"] = anonymousValidator964861468(
    value["$or"],
    `${propertyPath}.$or`,
    errors,
  );
  ...
  result["expiresIn"] = anonymousValidator1463484601(
    value["expiresIn"],
    `${propertyPath}.expiresIn`,
    errors,
  );
  result["expiresNotIn"] = anonymousValidator1463484601(
    value["expiresNotIn"],
 ...
 * @returns {undefined|StoreFileWhere|undefined}
 */
export function anonymousValidator2011204092(
  value,
  propertyPath,
  errors = [],
  ...
  return anonymousValidator208334559(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 * @returns {undefined|StoreFileGroupWhere|undefined}
 */
export function anonymousValidator1882271191(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator416492486(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator2110413806(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator1639293803(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator664458812(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator1215466022(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 * @returns {undefined|StoreFileGroupQueryTraverser|undefined}
 */
export function anonymousValidator1292148604(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator1215466022(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1215466022.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1882271191(
    value["where"],
    `${propertyPath}.where`,
    errors,
  );
  ...
  result["viaFile"] = anonymousValidator1884933646(
    value["viaFile"],
    `${propertyPath}.viaFile`,
    errors,
  );
  result["viaParent"] = anonymousValidator664458812(
    value["viaParent"],
    `${propertyPath}.viaParent`,
    errors,
  );
  result["viaChildren"] = anonymousValidator1292148604(
    value["viaChildren"],
 ...
 * @returns {undefined|StoreFileGroupQueryTraverser|undefined}
 */
export function anonymousValidator907013406(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 * @returns {undefined|StoreFileGroupViewWhere|undefined}
 */
export function anonymousValidator1322767881(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator1774761946(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator454080102(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator1325997287(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator1586152202(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator533501019(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 * @returns {undefined|StoreFileGroupViewQueryTraverser|undefined}
 */
export function anonymousValidator323554570(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator533501019(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys533501019.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1322767881(
    value["where"],
    `${propertyPath}.where`,
    errors,
  );
  ...
  result["viaFile"] = anonymousValidator454080102(
    value["viaFile"],
    `${propertyPath}.viaFile`,
    errors,
  );
  result["viaParent"] = anonymousValidator1586152202(
    value["viaParent"],
    `${propertyPath}.viaParent`,
    errors,
  );
  result["viaChildren"] = anonymousValidator323554570(
    value["viaChildren"],
    `${propertyPath}.viaChildren`,
    errors,
  );
 ...
 * @returns {undefined|StoreFileGroupViewQueryTraverser|undefined}
 */
export function anonymousValidator5281753(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator1325997287(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1325997287.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator2011204092(
    value["where"],
    `${propertyPath}.where`,
    errors,
  );
  ...
  result["viaGroup"] = anonymousValidator907013406(
    value["viaGroup"],
    `${propertyPath}.viaGroup`,
    errors,
  );
  result["viaGroupView"] = anonymousValidator5281753(
    value["viaGroupView"],
 ...
 * @returns {undefined|StoreFileQueryTraverser|undefined}
 */
export function anonymousValidator1884933646(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator1187785244(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator158500398(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 * @returns {undefined|StoreFileGroupQueryBuilder|undefined}
 */
export function anonymousValidator475037815(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator158500398(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys158500398.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1882271191(
  ...
  result["file"] = anonymousValidator2110413806(
    value["file"],
    `${propertyPath}.file`,
    errors,
  );
  ...
  result["parent"] = anonymousValidator1187785244(
    value["parent"],
    `${propertyPath}.parent`,
    errors,
  );
  ...
  result["children"] = anonymousValidator475037815(
    value["children"],
 ...
 * @returns {undefined|StoreFileGroupQueryBuilder|undefined}
 */
export function anonymousValidator853479594(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 * @returns {undefined|StoreFileQueryBuilder|undefined}
 */
export function anonymousValidator1559241216(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator1297834225(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator486606313(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 * @returns {undefined|StoreFileGroupViewQueryBuilder|undefined}
 */
export function anonymousValidator210426608(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator486606313(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys486606313.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1322767881(
  ...
  result["file"] = anonymousValidator1559241216(
    value["file"],
    `${propertyPath}.file`,
    errors,
  );
  ...
  result["parent"] = anonymousValidator1297834225(
    value["parent"],
    `${propertyPath}.parent`,
    errors,
  );
  ...
  result["children"] = anonymousValidator210426608(
    value["children"],
    `${propertyPath}.children`,
    errors,
  );
 ...
 * @returns {undefined|StoreFileGroupViewQueryBuilder|undefined}
 */
export function anonymousValidator20222822(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
 ...
 */
export function anonymousValidator1639293803(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1639293803.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator2011204092(
  ...
  result["group"] = anonymousValidator853479594(
    value["group"],
    `${propertyPath}.group`,
    errors,
  );
  ...
  result["groupView"] = anonymousValidator20222822(
    value["groupView"],
 ...
 * @returns {undefined|StoreJobWhere|undefined}
 */
export function anonymousValidator1662571246(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator1295027217(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator2046755126(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys2046755126.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1662571246(
    value["where"],
    `${propertyPath}.where`,
    errors,
  );
 ...
 */
export function anonymousValidator1276637142(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1276637142.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1662571246(
 ...
 * @returns {undefined|StoreSessionWhere|undefined}
 */
export function anonymousValidator1694107607(
  value,
  propertyPath,
  errors = [],
  parentType = "reference",
  ...
  return anonymousValidator609318220(value, propertyPath, errors);
}
/**
 * @param {*} value
 * @param {string} propertyPath
 ...
 */
export function anonymousValidator35809239(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys35809239.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1694107607(
    value["where"],
    `${propertyPath}.where`,
    errors,
  );
 ...
 */
export function anonymousValidator1575195633(
  value,
  propertyPath,
  errors = [],
  parentType = "object",
  ...
  const result = Object.create(null);
  for (const key of Object.keys(value)) {
    if (!objectKeys1575195633.has(key)) {
      throw buildError(parentType, "strict", { propertyPath, extraKey: key });
    }
  }
  result["where"] = anonymousValidator1694107607(
