...
export function sessionOrderBy(
  orderBy?: StoreSessionOrderBy | undefined,
  orderBySpec?: StoreSessionOrderBySpec | undefined,
  tableName?: string | undefined,
  options?:
    | {
        skipValidator?: boolean | undefined;
 ...
 * @returns {QueryPart}
 */
export function sessionInsertValues(
 ...
 */
declare function sessionDelete(
  sql: Postgres,
  where?: StoreSessionWhere | undefined,
): Promise<void>;
/**
 ...
 */
declare function sessionInsert(
  sql: Postgres,
  insert: StoreSessionInsertPartial | StoreSessionInsertPartial[],
  options?:
    | {
 ...
 * @returns {Promise<StoreSession[]>}
 */
declare function sessionUpsertOnId(
  sql: Postgres,
  insert: StoreSessionInsertPartial | StoreSessionInsertPartial[],
  options?: {} | undefined,
): Promise<StoreSession[]>;
 ...
 * @returns {Promise<StoreSession[]>}
 */
declare function sessionUpdate(
  sql: Postgres,
