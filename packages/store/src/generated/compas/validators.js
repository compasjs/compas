 ...
 * @returns {{ value: CompasSqlOrderBy, error?: never }|{ value?: never, error: AppError }}
 */
 ...
 * @param {undefined|any} value
 * @param {string|undefined} [propertyPath]
 * @returns {{ value: CompasSqlOrderByOptionalField, error?: never }|{ value?: never, error: AppError }}
 */
