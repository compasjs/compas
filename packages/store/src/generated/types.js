 ...
 * @name StoreFileStore
 *
 * @typedef { { id:string, bucketName:string, contentLength:number, contentType:string,
 ...
 *
 * @typedef { { id:string, bucketName:string, contentLength:number, contentType:string,
 *   filename:string, createdAt?:string, updatedAt?:string, }}
 */
 ...
 *
 * @typedef { { id:string, expires:string, data?:* , createdAt?:string,
 *   updatedAt?:string, }}
 */
 ...
 * @name StoreJobQueue
 *
 * @typedef { { id:number, isComplete:boolean, priority:number, scheduledAt:Date,
 *   name:string, data:*, createdAt:Date, updatedAt:Date, }}
 */

/**
 * @name StoreJobQueue_Input
 *
 * @typedef { { id:number, isComplete?:boolean , priority?:number , scheduledAt?:string,
 *   name:string, data?:* , createdAt?:string, updatedAt?:string, }}
 */

/**
 * @name StoreFileStoreWhere
 *
 * @typedef { { id?:string, idIn?:(string)[] , bucketName?:string ,
 *   bucketNameLike?:string , }}
 */
 ...
 *
 * @typedef { { bucketName:string, contentLength:number, contentType:string,
 *   filename:string, createdAt:Date, updatedAt:Date, }}
 */
 ...
 *
 * @typedef { { id?:number , idGreaterThan?:number , idLowerThan?:number , name?:string ,
 *   nameLike?:string , }}
 */
 ...
 *
 * @typedef { { isComplete:boolean, priority:number, scheduledAt:Date, name:string,
 ...
 *
 * @typedef { { isComplete?:boolean , priority?:number , scheduledAt?:string,
 *   name:string, data?:* , createdAt?:string, updatedAt?:string, }}
 */
