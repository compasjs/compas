...
export class AppError extends Error {
     ...
     * @returns {AppError}
     */
    static notFound(info?: Record<string, any> | undefined, error?: Error | undefined): AppError;
    /**
     * @param {Record<string, any>} [info={}]
     * @param {Error} [error]
     * @returns {AppError}
     */
    static notImplemented(info?: Record<string, any> | undefined, error?: Error | undefined): AppError;
    /**
     * @param {Record<string, any>} [info={}]
     * @param {Error} [error]
     * @returns {AppError}
     */
    static serverError(info?: Record<string, any> | undefined, error?: Error | undefined): AppError;
    /**
     * @param {string} key
     * @param {Record<string, any>} [info={}]
     * @param {Error} [error]
     * @returns {AppError}
     */
    static validationError(key: string, info?: Record<string, any> | undefined, error?: Error | undefined): AppError;
    /**
     ...
     */
    static format(e?: AppError | Error | undefined | null | {}): Record<string, any>;
    /**
     * @param {string} key
     * @param {number} status
     * @param {Record<string, any>} [info={}]
     ...
     */
    constructor(key: string, status: number, info?: Record<string, any> | undefined, originalError?: Error | undefined);
    key: string;
    status: number;
