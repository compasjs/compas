          ...
          database: T.object()
            .keys({
              ...
              skipValidatorGeneration: T.bool()
                .default(false)
                .docs(
                  `Unsafe skip generating and using validators to automatically convert the database result of the query builders to Compas valida types.`,
                ),
            })
            .optional()
          ...
          types: T.object()
            .keys({
              ...
              generateDeduplicatedTypes: T.bool()
                .default(false)
                .docs(
                  "Combine all types that would be generated by all structures added via 'Generator#addStructure' and combine them in to a single output. They can later be used via with `useDeduplicatedTypesPath` or in combination with `declareGlobalTypes`.",
                ),
